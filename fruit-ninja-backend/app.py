...
from game_page import GAME_PAGE_HTML
...
@app.route('/')
def index():
    """Root page with links to game and test UI"""
    return """
    <html>
    <head>
        <title>Fruit Ninja YOLO Backend</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            ...
            <p>Server is running with GPU acceleration!</p>

            <div class="card">
                <h2>🎯 Play the Game</h2>
                <p>Full fruit ninja game with hand detection in your browser:</p>
                <a href="/game" class="button">🍉 PLAY GAME 🍉</a>
                <a href="/test" class="button secondary">🔧 Testing UI</a>
            </div>

            <div class="card">
                <h2>📡 API Endpoints</h2>
                <ul>
                    <li><a href="/health" style="color:white;">/health</a> - Health check</li>
                    <li><a href="/model-info" style="color:white;">/model-info</a> - Model information</li>
                    <li><code>POST /detect</code> - Hand detection</li>
                    <li><code>POST /slice</code> - Fruit slicing</li>
                    <li><code>POST /process-video</code> - Video processing</li>
                    <li><code>POST /reset-device</code> - Clear GPU cache</li>
                </ul>
            </div>
        </div>
    </body>
...
@app.route('/game')
def game_page():
    """Full fruit ninja game with hand detection"""
    return render_template_string(GAME_PAGE_HTML)
...
if __name__ == '__main__':
    try:
        ...
        print("=" * 60)
        print(f" PLAY THE GAME:     http://localhost:{port}/game")
        print(f" Testing UI:        http://localhost:{port}/test")
        ...
        # Open browser automatically to the game (in background thread)
        browser_url = f"http://localhost:{port}/game"
